...
st.set_page_config(
    page_title="Credit Store Test - Minimal",
    page_icon="💳",
    layout="wide"
)

st.title("Credit Store UI Test - Minimal Implementation")
...
<div style="background-color: #1a2436; border: 1px solid #2a3a50; border-radius: 8px; padding: 1rem; margin-bottom: 1rem;">
    <h3 style="color: #FFFFFF; margin-top: 0;">🧪 Testing Credit Store UI - Minimal Implementation</h3>
    ...
    <ul style="color: #A0A0A0;">
        ...
        <li>Minimal dependencies to avoid import issues</li>
    </ul>
</div>
